...
import  math, strformat, strscans, strutils, tables
...
let
  t1 = "data/day14test1.txt"
  t2 = "data/day14test2.txt"
  t3 = "data/day14test3.txt"
  t4 = "data/day14test4.txt"
  t5 = "data/day14test5.txt"
