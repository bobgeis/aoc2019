...
# Compile command: 'nim c --hints=off --warnings=off  -d:danger -d:release --opt:speed -o:out/time_day12 nim/day12.nim'
# Run command: 'time ./out/time_day12'
# Day12
# Part1 13399
# Part2 312992287193064
