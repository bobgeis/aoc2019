...
# Compile command: 'nim c --hints=off --warnings=off  -d:danger -d:release --opt:speed -o:out/time_day22 nim/day22.nim'
# Run command: 'time ./out/time_day22'
# Day22
# Part1 1510
# Part2 10307144922975
