...
# local lib modules
import lib/[aocutils, intcode, vecna]
...
# Compile command: 'nim c --hints=off --warnings=off  -d:danger -d:release --opt:speed -o:out/time_day17 nim/day17.nim'
# Run command: 'time ./out/time_day17'
# Day17
# Part1 5940
# Part2 923795
