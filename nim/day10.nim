...
import std/[algorithm, math, sequtils, strformat, sugar, tables]
...
const
  inputTest1 = testFile(1)
  inputTest2 = testFile(2)
  inputTest3 = testFile(3)
...
# Compile command: 'nim c --hints=off --warnings=off  -d:danger -d:release --opt:speed -o:out/time_day10 nim/day10.nim'
# Run command: 'time ./out/time_day10'
# Day10
# Part1 340
# Part2 2628
