...
let data = fromFile(inputFile).map(parseInt)
...
# Compile command: 'nim c --hint[Conf]=off  -d:danger -d:release --opt:speed -o:out/time_day01 nim/day01.nim'
# Run command: 'time ./out/time_day01'
# Day01
# Part1 3226407
# Part2 4836738
